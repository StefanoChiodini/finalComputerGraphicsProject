...
***************/
	...
	//tail
	A->Triangle(-0.65,0.85,         -0.81,0.58,    -0.25, 0.85,        0.1,1,0.1);	//one green triangle
	A->Triangle(-0.4,0.58,         -0.81, 0.58,    -0.25, 0.85,        0.1,1,0.1);  //other green triangle

	// body cat
	A->Triangle(-0.25, 0.85,       -0.25, 0.1,      0.275, 0.85,       0, 0.45, 1);	//blue triangle
	A->Triangle(-0.25,0.1,          0.11,-0.4,       0.11,0.62,            1,0,0);  //red triangle 
	A->Triangle(0.38,-0.05,          0.11,-0.4,       0.11,0.35,         1, 1, 0);  //yellow triangle

	//head cat
	A->Triangle(0.3,-0.66,           0.11, -0.4,      0.3,-0.15,            1,0,1);  //purple triangle
	A->Triangle(0.3,-0.66,           0.49, -0.4,      0.3, -0.15,         1, 0, 1);  //purple triangle
	A->Triangle(0.3, -0.66,          0.49, -0.4,      0.49,-0.91,            0,1,1);         //light blue triangle
	A->Triangle(0.3, -0.66,          0.11, -0.4,      0.11,-0.91,           1, 0.2, 0.3);  //light purple triangle
}